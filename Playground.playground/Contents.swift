...
// MARK: - Computed + Observed properties task

// Calc number of bucket to paint this wall.
// Single bucket only coves 1.5 sqm
...
var bucketsOfPaint: Int {
    get {
        ...
        let coverPerBucket: Float = 1.5
        return Int(ceilf(area / coverPerBucket))
    }
    set {
        let areaToBeCovered = Double(newValue) * 1.5
        print("This is enough for \(areaToBeCovered)")
    }
}
...
// How many sqm we can covers if there is a few buckets left
